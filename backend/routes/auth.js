...
router.post('/createuser', [
    ...
    if(user){
        return res.status(400).json({success,error: "Sorry a user with same email id already exists"})
    }
...
// Get details of logged in user using : POST "/api/auth/getuser" login required
